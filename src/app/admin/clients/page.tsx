...
export default async function Page() {
  ...
  return (
    <div>
      <PageTitle eyebrow="Admin" title="Clients" description="Organisations you build for. Each one is isolated from the others." actions={<ModalButton label="Add client" title="Add client">{(done) => <ClientForm onDone={done} />}</ModalButton>} />
