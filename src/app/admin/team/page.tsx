...
export default async function Page() {
  ...
  return (
    <div>
      <PageTitle eyebrow="Admin" title="Team" description="Who works here and what they are carrying." actions={manage ? <ModalButton label="Invite staff" title="Invite a team member"><InviteForm organisations={[]} roles={user.role === "super_admin" ? ROLES : ROLES.filter((r) => r !== "super_admin")} /></ModalButton> : undefined} />
